...
MRBres.Adds(MRBa.elems{3});
MRBres.Setb(t/2);
% MRBres.Adds(MRBa.elems{6});
% MRBres.Adds(MRBa.elems{8});
% MRBres.Adds(MRBa.elems{10});
% MRBres.Adds(MRBa.elems{13});
% MRBres.Adds(MRBa.elems{15});
% MRBres.Adds(MRBa.elems{17});
% MRBres.Adds(MRBa.elems{20});
% 
% MRBres.Adds(MRBb.elems{1});
% MRBres.Adds(MRBb.elems{8});
% MRBres.Adds(MRBb.elems{26});
% MRBres.Adds(MRBc.elems{1});
% MRBres.Adds(MRBc.elems{8});
% MRBres.Adds(MRBc.elems{26});
