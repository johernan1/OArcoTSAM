...
MRBrst.RstAng=[[3,0];[3,MRBb.ucsA];[3,MRBc.ucsA]];
...
vectUa=MRBa.elems{6}.MatJU{1}(2,:);
vectUb=MRBb.elems{6}.MatJU{1}(2,:);
vectUc=MRBc.elems{6}.MatJU{1}(2,:);
vectUr=MRBrst.VectU{1};
cdgJa=MRBa.elems{6}.GetCdgJunt;
cdgJb=MRBb.elems{6}.GetCdgJunt;
cdgJc=MRBc.elems{6}.GetCdgJunt;
% El desplazamiento vertical tiene que ser el mismo
chk(' v junta MRBa / v MRBrst', vectUr(3),vectUa(2))
chk(' v junta MRBb / v MRBrst', vectUr(3),vectUb(2)-cdgJb(2,1)*vectUb(3))
chk(' v junta MRBc / v MRBrst', vectUr(3),vectUc(2)-cdgJc(2,1)*vectUc(3))

chk('Dl junta MRBa / ux*c+uy*s MRBrst', vectUa(1)+cdgJa(2,2)*vectUa(3), ...
    vectUr(1)*cos(MRBa.ucsA)+vectUr(2)*sin(MRBa.ucsA))
chk('Dl junta MRBb / ux*c+uy*s MRBrst', vectUb(1)+cdgJb(2,2)*vectUb(3), ...
    vectUr(1)*cos(MRBb.ucsA)+vectUr(2)*sin(MRBb.ucsA))
chk('Dl junta MRBc / ux*c+uy*s MRBrst', vectUc(1)+cdgJc(2,2)*vectUc(3), ...
