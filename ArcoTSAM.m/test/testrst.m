...
subsection ('SetConeS')
MRB.SetConeS;
iniFigureArcoTSAM('Name','testrst: rst.plot');

%% SE DEFINE UNA COACCION
%

MRB.NgdlCoeff=[[1,0.5];[1,0.5];[1,0.5]];
MRB.plotj
xxx=xx
...
chk('Hipotesis G, gamma=10', sum(vectG1), 2800)
MRB.SetG(1);
vectG2=MRB.Getf(2);
vectG3=MRB.Getf(1);
chk('Hipotesis G, gamma=1',  sum(vectG3), 280)
chk('Suma de hipotesis', sum(vectG1+vectG2), 2800+280)
