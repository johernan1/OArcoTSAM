...
apoyoAsiento=MRBb.elems{1};
apoyoAsiento1=MRBa.elems{1};
ijunt=1;
alpha=pi*0;
gammau=1;
...
%             coneSApoyo=MRB.elems{2}.elems{apoyoAsiento}.GetConeSjunta(ijunt);
%             sdir = MRB.elems{2}.elems{apoyoAsiento}.GetSdir(ijunt, alpha);                  
%             
%             c = zeros(MRB.GetNs,1);
%             c(coneSApoyo) = sdir; 
%             coneSApoyo=MRB.elems{1}.elems{apoyoAsiento}.GetConeSjunta(ijunt);
%             sdir = MRB.elems{1}.elems{apoyoAsiento}.GetSdir(ijunt, alpha);   
%             c(coneSApoyo) = sdir; 
...
chk(sprintf('Reacción horizontal en transom: (%f)', ...
        MRBa.elems{1}.VectS{1}(2)),MRBa.elems{1}.VectS{1}(2), -53.924792);
chk(sprintf('Reacción vertical en transom: (%f)', ...
    MRBa.elems{1}.VectS{1}(3)),MRBa.elems{1}.VectS{1}(3), -17.987500);
chk(sprintf('Reacción horizontal en transom: (%f)', ...
    MRBa.elems{MRBa.GetNelems}.VectS{1}(4)), MRBa.elems{MRBa.GetNelems}.VectS{1}(5), -53.924792);
chk(sprintf('Reacción vertical en transom: (%f)\n', ...
    MRBa.elems{MRBa.GetNelems}.VectS{1}(6)),MRBa.elems{MRBa.GetNelems}.VectS{1}(6),-0.037500);
